...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        phones.add(new NewPhone("DTM01", "Iphone 8 Plus", 20000, 12, "Iphone", 10));
        phones.add(new NewPhone("DTM02", "Iphone 12", 240000, 12, "Iphone", 5));

        phones.add(new OldPhone("DTC01", "Iphone 8 Plus", 40000, 12, "Iphone", "Tốt", "99% new like"));
        phones.add(new OldPhone("DTC02", "Iphone 13", 100000, 12, "Iphone", "Tốt", "99% new like"));
...
//            do {
            ...
            switch (choose) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    System.out.println("Tổng giá của tất cả các điện thoại: " + totalPrice());
                    break;
                case 8:
                    System.out.print("Vui lòng nhập % khuyễn mãi : ");
                    double persentDiscount = Double.parseDouble(sc.nextLine());
                    applyDiscountToOldPhone(persentDiscount);
...
//            } while (choose < 1 || choose > 9);
    ...
    //7. tính tổng giá các điện thoại
    public static double totalPrice() {
        double totalPrice = 0;
        for (Phone phone : phones) {
            totalPrice = totalPrice + phone.calculateTotalPrice();
        }
        return totalPrice;
    }

    // áp dụng mã giảm giá cho điện thoại cũ
    public static void applyDiscountToOldPhone(double percentDiscount) {
        for (Phone phone : phones) {
            if (phone instanceof OldPhone) {
                ((OldPhone) phone).discount(percentDiscount);
            }
        }
    }
}
